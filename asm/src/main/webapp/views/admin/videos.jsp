...
<div class="container mt-5" ng-app="app" ng-controller="videoController">
        ...
        <div class="tab-pane fade " id="video-edition" role="tabpanel" aria-labelledby="video-edition-tab">
          <form name="videoManage" class="container-fluid row px-2 mt-5">
            ...
            <div class="col-12 d-flex justify-content-end mt-3 align-items-center mb-3">
              ...
              <button id="create" ng-disabled="isEdit || isLoading" ng-click="submit($event)" class="btn btn-primary me-2 ">
              	Create 
              </button>
              <button id="update" ng-disabled="!isEdit || isLoading" ng-click="update($event)" class="btn btn-primary me-2 ">
              	Update 
              </button>
              <button id="delete" ng-disabled="!isEdit || isLoading" ng-click="delete($event)" class="btn btn-danger me-2 ">
              	Delete 
              </button>
              <button id="reset" ng-disabled="isLoading" ng-click="reset($event)" class="btn btn-primary me-2">
              	Reset
              </button>
            </div>
          </form>
    ...
    <div class="toast-container position-fixed top-0 start-50 translate-middle-x">
      <div id="videoToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div id="toast-wrapper" class="toast-body d-flex align-items-center {{toastData.class}}">
