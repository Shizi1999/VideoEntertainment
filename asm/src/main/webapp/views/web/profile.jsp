      ...
      <div class="col-sm-12 col-md-10">
        ...
        <div class="cus-nav-content {{activeTab === 0 ? 'active':''}}">
          ...
          <form name="profileForm" ng-submit="updateInfomation()" class="rounded-2 w-50 ps-2">
            ...
            <button id="changeInfo" ng-disabled="isUpdatingInfo" class="btn btn-primary d-flex align-items-center">
        ...
        <div class="cus-nav-content {{activeTab === 1 ? 'active':''}}">
          ...
          <form name="profileForm" ng-submit="changePassword()" class="rounded-2 w-50 ps-2">
            ...
            <button  id="changePassword" ng-disabled="isChangingPassword" class="btn btn-primary d-flex align-items-center">
        ...
        <div ng-show="!!successMessage && loaded" class="alert alert-success mt-2 w-50"  id="success" role="alert">{{successMessage}}</div>
        <div ng-show="!!errorMessage && loaded" class="alert alert-danger mt-2 w-50" id="error" role="alert">{{errorMessage}}</div>
      </div>
     <!-- Modal -->
    <div
      class="modal fade"
