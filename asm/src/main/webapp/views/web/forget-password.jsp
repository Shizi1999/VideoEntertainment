 ...
 <div
    ...
    >
      ...
      >
        ...
        <div class="mt-4">
        	<button ng-disabled="isLoading" id="submitBtn" class="btn btn-primary d-flex align-items-center">
        		Confirm <div ng-if="isLoading" class="spinner-border text-light ms-2" role="status"></div>
        	</button>
        </div>
        <div ng-show="!!successMessage" id="success" class="alert alert-success mt-2" role="alert">{{successMessage}}</div>
        <div ng-show="!!errorMessage" id="error" class="alert alert-danger mt-2" role="alert">{{errorMessage}}</div>
      </form>
    </div>
