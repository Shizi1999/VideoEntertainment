        ...
        <div class="col-sm-12 col-md-12 col-lg-8 d-block mb-2">
          ...
          <c:if test="${isLogin}">
	          <div class="my-3">
	            ...
	            <div id="open-btn" ng-click="showModal()" class="d-inline-block border pointer px-3 py-2 rounded-5"><i class="bi bi-share-fill"></i> Share</div>
	          </div>
          </c:if>
          <c:if test="${!isLogin}">
	          <div class="my-3">
	            <a id="react" href="${pageContext.request.contextPath}/sign-in" class="d-inline-block border pointer px-3 py-2 rounded-5 text-secondary text-decoration-none">
	              <i class="bi bi-heart"> ${favoriteCount}</i>
	            </a>
	            <a id="open-btn" href="${pageContext.request.contextPath}/sign-in" class="d-inline-block border pointer px-3 py-2 rounded-5 text-secondary text-decoration-none">
          ...
          <div class="modal-body px-4">
            ...
            <div class="input-group mt-3">
              <input
                ...
                ng-model="emailInput"
              />
              <span class="input-group-text" ng-click="addEmail()" id="add-email-btn">Add email</span>
            </div>
            ...
            <div id="success" ng-show="!!successMessage" class="alert alert-success mt-2" role="alert">{{successMessage}}</div>
        	<div id="error" ng-show="!!errorMessage" class="alert alert-danger mt-2" role="alert">{{errorMessage}}</div>
          </div>
        </div>
      </div>
    </div>
