...
<div
    ...
    >
      ...
      >
        ...
        <div ng-show="!!errorMessage" id="error" class="alert alert-danger mt-4" role="alert">{{errorMessage}}</div>
        <div ng-show="!!successMessage" id="success" class="alert alert-success mt-4" role="alert">{{successMessage}}</div>
      </form>
    </div>
